...
export const SEASONAL_CAMOS: SeasonalCamo[] = [
  ...
  { id: "dream-aurora", name: "Dream Aurora", texture: "/seasonal/dream-aurora.webp", order: 15, source: "Event" },
  { id: "carmine", name: "Carmine", texture: "/seasonal/carmine.webp", order: 16, source: "Tournament" },
  ...
  { id: "astronomy", name: "Astronomy", texture: "/seasonal/astronomy.webp", order: 23, source: "Event" },
  { id: "ocean-waves", name: "Ocean Waves", texture: "/seasonal/ocean-waves.webp", order: 24, source: "Secret Cache" },
  ...
  //{ id: "RitaRossweisseCXB", name: "RitaRossweisseCXB", texture: "/seasonal/ritarossweissecxb.webp", order: -, source: "Cancelled" },
